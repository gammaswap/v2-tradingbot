...
export const CFG = {
    ...
    EXCHANGE_CONTRACT: envStr("EXCHANGE_CONTRACT", "0x5A137E6DbEDbD01A716DfaFe534479CDF8f6be9C"),
    VERIFYING_CONTRACT: envStr("VERIFYING_CONTRACT", "0x5A137E6DbEDbD01A716DfaFe534479CDF8f6be9C"),
